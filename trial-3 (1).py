...
news_api_key = "73e2bb4a6bce4b1b835f6c4d8cfb4359"  # Example; replace with real key if different
...
if city:
    if openweather_api_key:
        try:
            ...
            if response.status_code == 200 and weather_data.get("main"):
                ...
                st.error("Weather data not found. Check the city name.")
        except Exception:
